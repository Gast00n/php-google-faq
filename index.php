...
<head>
    ...
    <!-- Lato for Titles - Roboto for Texts -->
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Lato:wght@900&family=Roboto:wght@100;400;500;700&display=swap" rel="stylesheet">
    <!-- FontAwesome -->
...
<body>
    ...
    <header>
        <div class="row">
            <ul class="logo-title">
                <li><img src="./img/googlelogo.svg" alt="Google Logo"></li>
